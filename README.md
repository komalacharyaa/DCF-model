...
This five-year Discounted Cash Flow (DCF) model estimates the **intrinsic value** of publicly listed companies by projecting future cash flows and discounting them back to today. It pulls historical and current financials via the `yfinance` API and then:

- Forecasts future **revenue**
- Computes **EBIT**, **EBIAT**, and **Free Cash Flow (FCF)**
- Estimates the **Weighted Average Cost of Capital (WACC)**
- Calculates **Terminal Value**

From these, the model derives an **implied share price** and a **margin of safety**, helping you compare your valuation to the market price. It also uses a **bisection routine** to find the **implied revenue growth rate** that reconciles your DCF value with the current market price, giving a sense of what growth the market is pricing in.
